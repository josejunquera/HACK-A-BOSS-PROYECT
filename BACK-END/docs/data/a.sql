...
CREATE TABLE `banda` (
  ...
  `busco_solista` varchar(50) COLLATE utf8mb4_spanish_ci DEFAULT NULL,
  `busco_actuacion` varchar(50) COLLATE utf8mb4_spanish_ci DEFAULT NULL,
...
INSERT INTO `es_tocado_solista` VALUES (8,1),(9,1),(9,2),(9,2);
...
CREATE TABLE `solista` (
  ...
  `id_usuario` int unsigned NOT NULL,
  `busco_banda` varchar(10) COLLATE utf8mb4_spanish_ci DEFAULT NULL,
  `busco_actuacion` varchar(10) COLLATE utf8mb4_spanish_ci DEFAULT NULL,
  `localizacion` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci NOT NULL,
...
-- Dump completed on 2021-02-03 10:50:41
