...
INSERT INTO `banda` VALUES (26,22,'si','si','Sada','provincial','Algo que contar','banda1'),(28,24,'si','si','Sevilla','nacional','Algo que contar','banda3'),(29,25,'si','si','Murcia','internacional','Algo que contar','banda4');
...
CREATE TABLE `es_contratado_banda` (
  ...
  `nombre_local_evento` varchar(100) COLLATE utf8mb4_spanish_ci DEFAULT NULL,
  `nombre_banda` varchar(100) COLLATE utf8mb4_spanish_ci DEFAULT NULL,
...
CREATE TABLE `es_contratado_solista` (
  ...
  `respuesta` enum('Aceptada','Rechazada','Pendiente') CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci DEFAULT 'Pendiente',
  `nombre_local_evento` varchar(100) COLLATE utf8mb4_spanish_ci DEFAULT NULL,
  `nombre_solista` varchar(100) COLLATE utf8mb4_spanish_ci DEFAULT NULL,
  UNIQUE KEY `id_contrato` (`id_contrato`),
...
INSERT INTO `local_evento` VALUES (7,22,'Local1','Sada','Algo que contar'),(9,24,'Local3','Sevilla','Algo que contar'),(10,25,'Local4','Murcia','Algo que contar');
...
INSERT INTO `solista` VALUES (14,22,'si','si','A Coruña','guitarrra','internacional','Descripcion','solista1'),(16,24,'si','no','Sevilla','Bajo','nacional','Algo que contar','solista3'),(17,25,'si','no','Murcia','Piano','nacional','Algo que contar','solista4');
...
INSERT INTO `usuario` VALUES (22,'usuario1@yopmail.com','$2b$12$AawrqzH0.1I9w9O3dJAXFOmRjhl9L0lVeymEUjKzjCozc9zqCs6fS','usuario1','usuario1','usuario1','reader',NULL),(23,'usuario2@yopmail.com','$2b$12$P2ewrdE43cYA6ixkXdcZb.cgjtefGyn0EjhcUFsqVESbxn7tkQ4Pe','usuario2','usuario2','usuario2','reader',NULL),(24,'usuario3@yopmail.com','$2b$12$UvI6uSj5uAKY2sigvsddMOeYGPGwoO4zhZhbYRd0zFpVR73TPc8d2','usuario3','usuario3','usuario3','reader',NULL),(25,'usuario4@yopmail.com','$2b$12$ltQeIFPAV/DGGPdWGw93LeAVTeARQtwUFId8DHr4Lr5AOQRvjzUEa','usuario4','usuario4','usuario4','reader',NULL);
...
-- Dump completed on 2021-03-11 20:04:18
